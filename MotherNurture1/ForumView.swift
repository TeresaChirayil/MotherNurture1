...
//        .background(Color(hex: "F8F5EE"))
//        .overlay(RoundedRectangle(cornerRadius: 12).stroke(Color(hex: "8B9A7E"), lineWidth: 0.5))
//        .cornerRadius(12)
...
//        .padding()
//        .background(Color(hex: "F8F5EE"))
//        .overlay(RoundedRectangle(cornerRadius: 10).stroke(Color(hex: "8B9A7E"), lineWidth: 0.5))
//        .cornerRadius(10)
//    }
//}
//
